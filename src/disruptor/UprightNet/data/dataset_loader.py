...
from disruptor.UprightNet.data.base_data_loader import BaseDataLoader
from disruptor.UprightNet.data.image_folder import *
import sys
...
class InferenceDataLoader(BaseDataLoader):
    def __init__(self, opt, list_path, is_train, _batch_size, num_threads):
        ...
        self.data_loader = torch.utils.data.DataLoader(dataset,
                                                       batch_size=_batch_size, shuffle=is_train,
