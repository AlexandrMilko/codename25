...
from UprightNet.models.base_model import BaseModel
from UprightNet.models import networks
import sys
import os.path
import cv2
...
class UprightNet(BaseModel):
    ...
    def infer_model(self, input_):
        # switch to evaluation mode
        input_ = input_.unsqueeze(0)
        with torch.no_grad():
            input_imgs = Variable(input_.cuda() , requires_grad = False)
            print("Input shape before forward pass:", input_imgs.shape)
        ...
        return pred_cam_geo_unit, pred_up_geo_unit, pred_weights
